<template>
  <div   class="p-20 w-full flex flex-col items-center justify-center space-y-3 ">
    ...
    <div class="w-2/3  shadow-xl   p-5">
      <div class="border-2 border-orange-200 p-5 py-20 flex flex-col items-center justify-center space-y-10 text-center shadow-sm">
        <a href="" class=" underline text-2xl">
          2540 E Fake Ave, Meridian, ID 84243
        </a>
        <a href="" class=" underline text-2xl">
          772-555-5555
        </a>
